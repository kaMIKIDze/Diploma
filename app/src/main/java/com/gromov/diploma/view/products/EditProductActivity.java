        ...
        switch (item.getItemId()) {
            case R.id.save_product:
                if (String.valueOf(productName.getText()).isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "you must enter a product name",
                            Toast.LENGTH_SHORT).show();
                    return false;
                }
                if (String.valueOf(costProduct.getText()).isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "you must enter a product cost",
                            Toast.LENGTH_SHORT).show();
                    return false;
                }
                if (String.valueOf(countProduct.getText()).isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "you must enter a product count",
                            Toast.LENGTH_SHORT).show();
                    return false;
                }
